          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Encontre postos proximos', style: TextStyle(color: AppTheme.textSecondary)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _loading ? const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text('Entrar'),
                  ),
                ),
                const SizedBox(height: 16),
                TextButton(
                  onPressed: () => context.go('/register'),
                  child: const Text('Nao tem conta? Cadastrar', style: TextStyle(color: AppTheme.primary)),
                ),
              ],
            ),
          ),
